          ...
          {!isSubmitted ? (
            ...
            <div className="text-center space-y-6 py-4 animate-fadeIn">
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-extrabold text-[#0F172A]">Check Your Email</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
                  We have dispatched a password recovery link to <strong className="text-slate-800">{email}</strong>.
                  Please check your spam or junk folder if it does not appear within 2 minutes.
                </p>
              </div>
