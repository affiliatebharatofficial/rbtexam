    ...
    <div className="py-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10 min-h-screen">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        <Badge variant="blue" className="gap-1">
          ...
          <span>BACB® 2nd Edition Task List Standard</span>
        </Badge>
        ...
        <p className="text-base text-slate-600 leading-relaxed">
          Master all 6 BACB Task List domains (Measurement, Assessment, Skill Acquisition, Behavior Reduction, Documentation, Ethics) with 85-question mock exams, Leitner flashcards, and Socrates AI Tutor mentorship.
        </p>
      ...
      <div className="space-y-6">
        <h2 className="text-2xl font-bold text-[#0F172A] text-center">
          BACB 2nd Edition Task List Domains Breakdown
        </h2>
