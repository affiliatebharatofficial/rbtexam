...
const translations: Record<SupportedLanguage, Record<string, string>> = {
  en: {
    ...
    // Hero & General UI
    'hero.badge': 'Aligned with BACB RBT 3rd Edition Test Content Outline',
    'hero.titlePrefix': 'Pass Your',
    'hero.titleHighlight': 'RBT Certification',
    'hero.titleSuffix': 'with Confidence',
    'hero.subtitle': 'Practice realistic RBT questions, take full-length 85-question mock exams, learn with Socrates AI Tutor, master flashcards, and track your readiness.',
    'hero.bullet1': '85-Question 90-Min Timed Exam Simulator',
    'hero.bullet2': 'Socrates AI Ethics & Clinical Tutor',
    'hero.bullet3': 'Domains A-F TCO Coverage (43 Tasks)',
    'hero.bullet4': 'Domain Diagnostic Heatmaps & Analytics',
    ...
    'features.feat2.desc': 'Interact with our conversational AI tutor guided by the RBT Ethics Code 2.0. Simulate challenging client scenarios, extinction bursts, and parent boundary situations in real-time.',
    ...
    'features.feat4.title': 'BACB RBT 3rd Ed TCO Mastery',
    'features.feat4.desc': 'Complete breakdown of all 6 TCO Domains (A through F). Track individual task item mastery across all 43 tasks from A.1 to F.10.',
    ...
    'features.feat6.desc': 'Supervisors and BCBAs can oversee trainee cohorts, track student exam readiness scores, assign practice tests, and verify team pass readiness.',
    ...
    'howItWorks.step1.desc': 'Answer targeted practice questions representing all 6 BACB RBT 3rd Edition Test Content Outline domains. Our scoring engine measures your response speed, confidence level, and conceptual accuracy.',
    ...
    'howItWorks.step2.desc': 'Socrates AI generates a customized daily study schedule. It prioritizes low-confidence domains like C.4 (Discrete Trial Teaching) or D.2 (Differential Reinforcement) to maximize score gain.',
    ...
    // Statistics
    'stats.candidates': 'Diagnostic Scenarios',
    'stats.candidatesSub': 'Full 85-question mock format',
    'stats.passRate': 'Curriculum Coverage',
    'stats.passRateSub': 'All 6 BACB 3rd Edition Domains',
    'stats.questions': 'Clinical Task Items',
    'stats.questionsSub': '43 discrete competencies mapped',
    'stats.rating': 'Exam Simulation',
    'stats.ratingSub': '90-minute timed Pearson VUE style',
    ...
    'cta.standards': 'Aligned with BACB RBT 3rd Edition Test Content Outline (Domains A-F)',
  ...
  es: {
    ...
    // Hero & General UI
    'hero.badge': 'Alineado con el Temario RBT 3ª Edición del BACB',
    ...
    'hero.bullet1': 'Simulador de Examen de 85 Preguntas y 90 Minutos',
    'hero.bullet2': 'Tutor de IA Sócrates para Razonamiento Clínico y Ético',
    'hero.bullet3': 'Cobertura Completa de Dominios A–F (43 Tareas del TCO)',
    'hero.bullet4': 'Mapas de Calor Diagnósticos y Análisis de Rendimiento',
    ...
    // Footer
    'footer.brandDescription': 'La plataforma líder RBT Practice AI para la preparación del examen RBT con preguntas de práctica por escenarios, exámenes simulados de 85 preguntas, tarjetas de repetición espaciada y tutor de IA para candidatos a la certificación BACB.',
    ...
    'features.feat2.desc': 'Interactúa con nuestro tutor de IA conversacional guiado por el Código de Ética RBT 2.0. Simula escenarios complejos de clientes, explosiones de extinción y situaciones de límites con padres en tiempo real.',
    ...
    'features.feat4.desc': 'Desglose completo de los 6 dominios del temario (A a F). Monitorea el dominio de cada una de las 43 tareas desde A.1 hasta F.10.',
    ...
    'features.feat6.desc': 'Los supervisores y BCBA pueden supervisar grupos de practicantes, rastrear puntajes de preparación para el examen, asignar pruebas de práctica y verificar la preparación del equipo.',
    ...
    'howItWorks.step2.desc': 'Sócrates IA genera un calendario de estudio diario adaptado que prioriza áreas de menor confianza como C.4 (DTT) o D.2 (Refuerzo Diferencial) para maximizar tu puntaje.',
    ...
    // Statistics
    'stats.candidates': 'Escenarios de Diagnóstico',
    'stats.candidatesSub': 'Formato simulado completo de 85 preguntas',
    'stats.passRate': 'Cobertura del Plan de Estudios',
    'stats.passRateSub': 'Los 6 dominios de la 3ª edición del BACB',
    'stats.questions': 'Tareas Clínicas',
    'stats.questionsSub': '43 competencias discretas mapeadas',
    'stats.rating': 'Simulación de Examen',
    'stats.ratingSub': '90 minutos cronometrados estilo Pearson VUE',
    ...
    'cta.standards': 'Alineado con el Temario BACB RBT 3ª Edición (Dominios A-F)',
