  ...
  const steps = [
    {
      ...
      interactiveContent: {
        domainScores: [
          { domain: 'A. Data Collection', score: 85, color: 'bg-emerald-500' },
          { domain: 'B. Behavior Assessment', score: 90, color: 'bg-[#2563EB]' },
          { domain: 'C. Behavior Acquisition', score: 58, color: 'bg-amber-500' },
          { domain: 'D. Behavior Reduction', score: 62, color: 'bg-amber-500' },
          { domain: 'E. Documentation', score: 95, color: 'bg-emerald-500' },
          { domain: 'F. Ethics', score: 72, color: 'bg-blue-400' },
        ],
      },
    },
    {
