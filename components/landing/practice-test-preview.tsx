  ...
  const questions = [
    {
      ...
      code: 'C-04',
      question: 'An RBT presents a flashcard of a red circle, immediately models the word "Red", and reinforces the client when they repeat "Red". Over successive trials, the RBT delays saying "Red" to allow the client to respond independently. What procedure is being used?',
      options: [
        { id: 'A', text: 'Prompt Fading (Most-to-Least / Time Delay)', correct: true },
        { id: 'B', text: 'Stimulus Generalization', correct: false },
        { id: 'C', text: 'Extinction Burst Protocol', correct: false },
        { id: 'D', text: 'Free Operant Preference Assessment', correct: false },
      ],
      explanation: 'Correct! Delaying the prompt over successive trials to allow independent responding is Time Delay Prompt Fading, a key skill acquisition procedure under BACB Task Item C-04.',
    },
    {
      id: 2,
      domain: 'Domain A: Measurement',
      code: 'A-02',
      question: 'An RBT records the exact time that elapses from when the BCBA delivers the instruction "Sit down" until the client physically begins to sit down. What continuous measurement dimension is being recorded?',
      options: [
        { id: 'A', text: 'Duration', correct: false },
        { id: 'B', text: 'Inter-Response Time (IRT)', correct: false },
        { id: 'C', text: 'Latency', correct: true },
        { id: 'D', text: 'Frequency / Rate', correct: false },
      ],
      explanation: 'Correct! Latency measures the elapsed time from the onset of a stimulus (SD instruction) to the initiation of the response behavior.',
    },
    {
      id: 3,
      domain: 'Domain F: Professional Conduct',
      code: 'F-[#0F172A]',
      question: 'During a home session, the client\'s parent asks the RBT for advice regarding changing the child\'s speech therapy schedule. How should the RBT respond under BACB guidelines?',
      options: [
        { id: 'A', text: 'Provide personal advice based on experience', correct: false },
        { id: 'B', text: 'Politely redirect the parent to discuss treatment changes with the supervising BCBA', correct: true },
        { id: 'C', text: 'Change the ABA session schedule independently', correct: false },
        { id: 'D', text: 'Ignore the parent\'s question', correct: false },
      ],
      explanation: 'Correct! RBTs must maintain professional boundaries (Domain F-02) and redirect all clinical programming or cross-disciplinary questions to their supervising BCBA.',
    },
  ];
          ...
          <div className="flex items-center justify-between pb-4 mb-6 border-b border-slate-200/80">
            ...
            <div className="flex items-center space-x-4 text-xs text-slate-500 font-medium">
              <div className="flex items-center space-x-1 font-mono text-slate-700 bg-slate-100 px-2.5 py-1 rounded-md">
                ...
                <span>01:14 remaining</span>
              </div>
              <span className="font-bold text-[#2563EB]">Score: {score}/{questions.length}</span>
            </div>
          </div>
