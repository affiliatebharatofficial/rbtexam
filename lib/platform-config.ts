...
const SYSTEM_CONFIG_STORE: Record<string, any> = {
  brandName: 'RBT Practice Questions',
  logoUrl: '/logo.svg',
  faviconUrl: '/favicon.ico',
  primaryColor: '#2563EB',
  secondaryColor: '#0F172A',
  companyName: 'RBT Practice Questions Inc.',
  supportEmail: 'support@rbtpracticequestions.com',
  supportPhone: '+1 (800) 555-0199',
  footerCopyright: '© 2026 RBT Practice Questions Inc. All rights reserved.',
  socialLinks: {
    twitter: 'https://twitter.com/rbtpracticequestions',
    linkedin: 'https://linkedin.com/company/rbtpracticequestions',
    facebook: 'https://facebook.com/rbtpracticequestions',
  },
  ...
  smtp: {
    ...
    senderName: 'RBT Practice Questions Candidate Portal',
    senderEmail: 'no-reply@rbtpracticequestions.com',
  },
  landing: {
    heroTitle: 'Pass Your RBT Certification with Confidence',
    heroSubtitle: 'Practice thousands of realistic RBT questions, take full-length mock exams, learn with AI Tutor, master flashcards and track your progress.',
    ctaButtonText: 'Start Free Practice',
