...
const SYSTEM_CONFIG_STORE: Record<string, any> = {
  ...
  socialLinks: {
    twitter: 'https://twitter.com/rbtpracticeai',
    linkedin: 'https://linkedin.com/company/rbtpracticeai',
    facebook: 'https://facebook.com/rbtpracticeai',
  },
  ...
  landing: {
    ...
    heroSubtitle: 'AI-powered RBT practice questions, realistic mock exams, flashcards, and personalized study tools designed around the current RBT exam content outline.',
    ctaButtonText: 'Start Practicing',
...
export const REGISTERED_PLUGINS: PlatformPlugin[] = [
  { id: 'plug-questions', name: 'Master Question Bank Engine', version: 'v1.4.0', status: 'active', isEnabled: true, category: 'Core Learning', description: 'BACB RBT 3rd Edition TCO question generator & CSV manager.', menuLabel: 'Question Bank', route: '/admin/questions' },
